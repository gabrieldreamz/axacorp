...
export default function IntroText() {
  return (
    <div className="max-w-4xl mx-auto mt-16 lg:mt-24 px-5 md:px-0">
      <h1 className=" max-w-2xl sm:max-w-3xl lg:max-w-4xl mx-auto flex flex-wrap justify-center gap-3 text-5xl lg:text-7xl font-bold text-center">
        Stress{" "}
        <span>
      ...
      <div className="flex justify-center">
        <CustomBtn
          ...
          otherStyles="bg-blue-500 px-7 font-bold text-sm lg:text-base py-4 mt-10 hover:bg-[#9b8bff]"
        />
      </div>
    </div>
  );
